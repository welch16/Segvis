...
```{r peaks_file,include=TRUE,echo=TRUE,eval=TRUE}
  ...
  segviz = SegvizData(regions = ctcf,files)
  segviz
...
A complete description of the meaning of each column in the peaks file is given in \url{https://genome.ucsc.edu/FAQ/FAQformat.html#format12}. Using the signal values (on the 7th column), we are going to consider the random 50 peaks per chromosome.
