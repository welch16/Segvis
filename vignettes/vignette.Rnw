...
We can even use functions created in the moment, they just need to
take a vector argument and return a 1 - dimensional value.
...
@   
  ...
  \caption{Median coverage plot, by using a previously defined \Rcode{ggplot} object}
\end{figure}
